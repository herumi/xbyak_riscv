...
void vfwmaccbf16_vf(const VReg& vd, const FReg& rs1, const VReg& vs2, VM vm=VM::unmasked) { opFVF(0xec005057, vm, vs2, rs1, vd); }
void vfwmaccbf16_vv(const VReg& vd, const VReg& vs1, const VReg& vs2, VM vm=VM::unmasked) { opFVV(0xec001057, vm, vs2, vs1, vd); }
