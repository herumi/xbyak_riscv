...
void vadc_vim(VReg vd, VReg vs2, int32_t simm5) { opIVI(0b01000000000000000011000001010111, 0, vs2, simm5, vd); }
void vadc_vvm(VReg vd, VReg vs2, VReg vs1) { opIVV(0b01000000000000000000000001010111, 0, vs2, vs1, vd); }
void vadc_vxm(VReg vd, VReg vs2, Reg rs1) { opIVX(0b01000000000000000100000001010111, 0, vs2, rs1, vd); }
...
void vcompress_vm(VReg vd, VReg vs2, VReg vs1) { opMVV(0b01011110000000000010000001010111, 0, vs2, vs1, vd); }
void vcpop_m(Reg rd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01000000000010000010000001010111, vm, vs2, 0, rd); }
...
void vfclass_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001100000010000001000001010111, vm, vs2, 0, vd); }
void vfcvt_f_x_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000000011001000001010111, vm, vs2, 0, vd); }
void vfcvt_f_xu_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000000010001000001010111, vm, vs2, 0, vd); }
void vfcvt_rtz_x_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000000111001000001010111, vm, vs2, 0, vd); }
void vfcvt_rtz_xu_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000000110001000001010111, vm, vs2, 0, vd); }
void vfcvt_x_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000000001001000001010111, vm, vs2, 0, vd); }
void vfcvt_xu_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000000000001000001010111, vm, vs2, 0, vd); }
...
void vfirst_m(Reg rd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01000000000010001010000001010111, vm, vs2, 0, rd); }
...
void vfmerge_vfm(VReg vd, VReg vs2, FReg rs1) { opFVF(0b01011100000000000101000001010111, 0, vs2, rs1, vd); }
...
void vfmv_f_s(FReg rd, VReg vs2) { opFVV(0b01000010000000000001000001010111, 0, vs2, 0, rd); }
void vfmv_s_f(VReg vd, FReg rs1) { opFVF(0b01000010000000000101000001010111, 0, 0, rs1, vd); }
void vfmv_v_f(VReg vd, FReg rs1) { opFVF(0b01011110000000000101000001010111, 0, 0, rs1, vd); }
void vfncvt_f_f_w(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000010100001000001010111, vm, vs2, 0, vd); }
void vfncvt_f_x_w(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000010011001000001010111, vm, vs2, 0, vd); }
void vfncvt_f_xu_w(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000010010001000001010111, vm, vs2, 0, vd); }
void vfncvt_rod_f_f_w(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000010101001000001010111, vm, vs2, 0, vd); }
void vfncvt_rtz_x_f_w(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000010111001000001010111, vm, vs2, 0, vd); }
void vfncvt_rtz_xu_f_w(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000010110001000001010111, vm, vs2, 0, vd); }
void vfncvt_x_f_w(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000010001001000001010111, vm, vs2, 0, vd); }
void vfncvt_xu_f_w(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000010000001000001010111, vm, vs2, 0, vd); }
...
void vfrec7_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001100000000101001000001010111, vm, vs2, 0, vd); }
...
void vfrsqrt7_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001100000000100001000001010111, vm, vs2, 0, vd); }
...
void vfsqrt_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001100000000000001000001010111, vm, vs2, 0, vd); }
...
void vfwcvt_f_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000001100001000001010111, vm, vs2, 0, vd); }
void vfwcvt_f_x_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000001011001000001010111, vm, vs2, 0, vd); }
void vfwcvt_f_xu_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000001010001000001010111, vm, vs2, 0, vd); }
void vfwcvt_rtz_x_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000001111001000001010111, vm, vs2, 0, vd); }
void vfwcvt_rtz_xu_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000001110001000001010111, vm, vs2, 0, vd); }
void vfwcvt_x_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000001001001000001010111, vm, vs2, 0, vd); }
void vfwcvt_xu_f_v(VReg vd, VReg vs2, VM vm=VM::unmasked) { opFVV(0b01001000000001000001000001010111, vm, vs2, 0, vd); }
...
void vid_v(VReg vd, VM vm=VM::unmasked) { opMVV(0b01010000000010001010000001010111, vm, 0, 0, vd); }
void viota_m(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01010000000010000010000001010111, vm, vs2, 0, vd); }
void vl1re16_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000101000000000111, 0, 0, rs1, vd); }
void vl1re32_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000110000000000111, 0, 0, rs1, vd); }
void vl1re64_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000111000000000111, 0, 0, rs1, vd); }
void vl1re8_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000000000000000111, 0, 0, rs1, vd); }
void vl2re16_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000101000000000111, 0, 0, rs1, vd); }
void vl2re32_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000110000000000111, 0, 0, rs1, vd); }
void vl2re64_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000111000000000111, 0, 0, rs1, vd); }
void vl2re8_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000000000000000111, 0, 0, rs1, vd); }
void vl4re16_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000101000000000111, 0, 0, rs1, vd); }
void vl4re32_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000110000000000111, 0, 0, rs1, vd); }
void vl4re64_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000111000000000111, 0, 0, rs1, vd); }
void vl4re8_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000000000000000111, 0, 0, rs1, vd); }
void vl8re16_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000101000000000111, 0, 0, rs1, vd); }
void vl8re32_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000110000000000111, 0, 0, rs1, vd); }
void vl8re64_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000111000000000111, 0, 0, rs1, vd); }
void vl8re8_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010100000000000000000000111, 0, 0, rs1, vd); }
void vlseg1e1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg2e1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00110000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg3e1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01010000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg4e1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01110000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg5e1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10010000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg6e1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10110000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg7e1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11010000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg8e1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11110000000000000111000000000111, vm, 0, rs1, vd); }
void vle1024_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg1e1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg2e1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00110001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg3e1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01010001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg4e1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01110001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg5e1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10010001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg6e1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10110001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg7e1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11010001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg8e1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11110001000000000111000000000111, vm, 0, rs1, vd); }
void vle1024ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg1e128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg2e128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00110000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg3e128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01010000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg4e128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01110000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg5e128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10010000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg6e128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10110000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg7e128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11010000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg8e128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11110000000000000000000000000111, vm, 0, rs1, vd); }
void vle128_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg1e128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg2e128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00110001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg3e128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01010001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg4e128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01110001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg5e128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10010001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg6e128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10110001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg7e128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11010001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg8e128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11110001000000000000000000000111, vm, 0, rs1, vd); }
void vle128ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg1e16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg2e16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00100000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg3e16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01000000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg4e16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01100000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg5e16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10000000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg6e16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10100000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg7e16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11000000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg8e16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11100000000000000101000000000111, vm, 0, rs1, vd); }
void vle16_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg1e16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg2e16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00100001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg3e16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01000001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg4e16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01100001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg5e16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10000001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg6e16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10100001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg7e16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11000001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg8e16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11100001000000000101000000000111, vm, 0, rs1, vd); }
void vle16ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg1e256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg2e256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00110000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg3e256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01010000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg4e256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01110000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg5e256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10010000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg6e256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10110000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg7e256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11010000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg8e256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11110000000000000101000000000111, vm, 0, rs1, vd); }
void vle256_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010000000000000101000000000111, vm, 0, rs1, vd); }
void vlseg1e256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg2e256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00110001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg3e256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01010001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg4e256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01110001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg5e256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10010001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg6e256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10110001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg7e256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11010001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg8e256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11110001000000000101000000000111, vm, 0, rs1, vd); }
void vle256ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010001000000000101000000000111, vm, 0, rs1, vd); }
void vlseg1e32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg2e32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00100000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg3e32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01000000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg4e32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01100000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg5e32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10000000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg6e32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10100000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg7e32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11000000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg8e32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11100000000000000110000000000111, vm, 0, rs1, vd); }
void vle32_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg1e32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg2e32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00100001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg3e32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01000001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg4e32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01100001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg5e32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10000001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg6e32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10100001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg7e32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11000001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg8e32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11100001000000000110000000000111, vm, 0, rs1, vd); }
void vle32ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg1e512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg2e512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00110000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg3e512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01010000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg4e512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01110000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg5e512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10010000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg6e512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10110000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg7e512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11010000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg8e512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11110000000000000110000000000111, vm, 0, rs1, vd); }
void vle512_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010000000000000110000000000111, vm, 0, rs1, vd); }
void vlseg1e512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg2e512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00110001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg3e512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01010001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg4e512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01110001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg5e512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10010001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg6e512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10110001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg7e512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11010001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg8e512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11110001000000000110000000000111, vm, 0, rs1, vd); }
void vle512ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00010001000000000110000000000111, vm, 0, rs1, vd); }
void vlseg1e64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg2e64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00100000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg3e64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01000000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg4e64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01100000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg5e64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10000000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg6e64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10100000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg7e64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11000000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg8e64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11100000000000000111000000000111, vm, 0, rs1, vd); }
void vle64_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000000000000000111000000000111, vm, 0, rs1, vd); }
void vlseg1e64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg2e64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00100001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg3e64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01000001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg4e64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01100001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg5e64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10000001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg6e64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10100001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg7e64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11000001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg8e64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11100001000000000111000000000111, vm, 0, rs1, vd); }
void vle64ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000001000000000111000000000111, vm, 0, rs1, vd); }
void vlseg1e8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg2e8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00100000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg3e8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01000000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg4e8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01100000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg5e8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10000000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg6e8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10100000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg7e8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11000000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg8e8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11100000000000000000000000000111, vm, 0, rs1, vd); }
void vle8_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000000000000000000000000000111, vm, 0, rs1, vd); }
void vlseg1e8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg2e8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00100001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg3e8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01000001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg4e8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b01100001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg5e8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10000001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg6e8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b10100001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg7e8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11000001000000000000000000000111, vm, 0, rs1, vd); }
void vlseg8e8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b11100001000000000000000000000111, vm, 0, rs1, vd); }
void vle8ff_v(VReg vd, Reg rs1, VM vm=VM::unmasked) { opVectorLoad(0b00000001000000000000000000000111, vm, 0, rs1, vd); }
void vlm_v(VReg vd, Reg rs1) { opVectorLoad(0b00000010101100000000000000000111, 0, 0, rs1, vd); }
...
void vmadc_vi(VReg vd, VReg vs2, int32_t simm5) { opIVI(0b01000110000000000011000001010111, 0, vs2, simm5, vd); }
void vmadc_vim(VReg vd, VReg vs2, int32_t simm5) { opIVI(0b01000100000000000011000001010111, 0, vs2, simm5, vd); }
void vmadc_vv(VReg vd, VReg vs2, VReg vs1) { opIVV(0b01000110000000000000000001010111, 0, vs2, vs1, vd); }
void vmadc_vvm(VReg vd, VReg vs2, VReg vs1) { opIVV(0b01000100000000000000000001010111, 0, vs2, vs1, vd); }
void vmadc_vx(VReg vd, VReg vs2, Reg rs1) { opIVX(0b01000110000000000100000001010111, 0, vs2, rs1, vd); }
void vmadc_vxm(VReg vd, VReg vs2, Reg rs1) { opIVX(0b01000100000000000100000001010111, 0, vs2, rs1, vd); }
...
void vmerge_vim(VReg vd, VReg vs2, int32_t simm5) { opIVI(0b01011100000000000011000001010111, 0, vs2, simm5, vd); }
void vmerge_vvm(VReg vd, VReg vs2, VReg vs1) { opIVV(0b01011100000000000000000001010111, 0, vs2, vs1, vd); }
void vmerge_vxm(VReg vd, VReg vs2, Reg rs1) { opIVX(0b01011100000000000100000001010111, 0, vs2, rs1, vd); }
...
void vmsbc_vv(VReg vd, VReg vs2, VReg vs1) { opIVV(0b01001110000000000000000001010111, 0, vs2, vs1, vd); }
void vmsbc_vvm(VReg vd, VReg vs2, VReg vs1) { opIVV(0b01001100000000000000000001010111, 0, vs2, vs1, vd); }
void vmsbc_vx(VReg vd, VReg vs2, Reg rs1) { opIVX(0b01001110000000000100000001010111, 0, vs2, rs1, vd); }
void vmsbc_vxm(VReg vd, VReg vs2, Reg rs1) { opIVX(0b01001100000000000100000001010111, 0, vs2, rs1, vd); }
void vmsbf_m(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01010000000000001010000001010111, vm, vs2, 0, vd); }
...
void vmsif_m(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01010000000000011010000001010111, vm, vs2, 0, vd); }
...
void vmsof_m(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01010000000000010010000001010111, vm, vs2, 0, vd); }
...
void vmv1r_v(VReg vd, VReg vs2) { opIVI(0b10011110000000000011000001010111, 0, vs2, 0, vd); }
void vmv2r_v(VReg vd, VReg vs2) { opIVI(0b10011110000000001011000001010111, 0, vs2, 0, vd); }
void vmv4r_v(VReg vd, VReg vs2) { opIVI(0b10011110000000011011000001010111, 0, vs2, 0, vd); }
void vmv8r_v(VReg vd, VReg vs2) { opIVI(0b10011110000000111011000001010111, 0, vs2, 0, vd); }
void vmv_s_x(VReg vd, Reg rs1) { opMVX(0b01000010000000000110000001010111, 0, 0, rs1, vd); }
void vmv_v_i(VReg vd, int32_t simm5) { opIVI(0b01011110000000000011000001010111, 0, 0, simm5, vd); }
void vmv_v_v(VReg vd, VReg vs1) { opIVV(0b01011110000000000000000001010111, 0, 0, vs1, vd); }
void vmv_v_x(VReg vd, Reg rs1) { opIVX(0b01011110000000000100000001010111, 0, 0, rs1, vd); }
void vmv_x_s(Reg rd, VReg vs2) { opMVV(0b01000010000000000010000001010111, 0, vs2, 0, rd); }
...
void vs1r_v(VReg vs3, Reg rs1) { opVectorStore(0b00000010100000000000000000100111, 0, 0, rs1, vs3); }
void vs2r_v(VReg vs3, Reg rs1) { opVectorStore(0b00000010100000000000000000100111, 0, 0, rs1, vs3); }
void vs4r_v(VReg vs3, Reg rs1) { opVectorStore(0b00000010100000000000000000100111, 0, 0, rs1, vs3); }
void vs8r_v(VReg vs3, Reg rs1) { opVectorStore(0b00000010100000000000000000100111, 0, 0, rs1, vs3); }
...
void vsbc_vvm(VReg vd, VReg vs2, VReg vs1) { opIVV(0b01001000000000000000000001010111, 0, vs2, vs1, vd); }
void vsbc_vxm(VReg vd, VReg vs2, Reg rs1) { opIVX(0b01001000000000000100000001010111, 0, vs2, rs1, vd); }
void vsseg1e1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00010000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg2e1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00110000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg3e1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01010000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg4e1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01110000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg5e1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10010000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg6e1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10110000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg7e1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11010000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg8e1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11110000000000000111000000100111, vm, 0, rs1, vs3); }
void vse1024_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00010000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg1e128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00010000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg2e128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00110000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg3e128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01010000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg4e128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01110000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg5e128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10010000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg6e128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10110000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg7e128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11010000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg8e128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11110000000000000000000000100111, vm, 0, rs1, vs3); }
void vse128_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00010000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg1e16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00000000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg2e16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00100000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg3e16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01000000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg4e16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01100000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg5e16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10000000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg6e16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10100000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg7e16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11000000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg8e16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11100000000000000101000000100111, vm, 0, rs1, vs3); }
void vse16_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00000000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg1e256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00010000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg2e256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00110000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg3e256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01010000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg4e256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01110000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg5e256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10010000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg6e256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10110000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg7e256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11010000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg8e256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11110000000000000101000000100111, vm, 0, rs1, vs3); }
void vse256_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00010000000000000101000000100111, vm, 0, rs1, vs3); }
void vsseg1e32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00000000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg2e32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00100000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg3e32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01000000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg4e32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01100000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg5e32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10000000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg6e32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10100000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg7e32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11000000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg8e32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11100000000000000110000000100111, vm, 0, rs1, vs3); }
void vse32_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00000000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg1e512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00010000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg2e512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00110000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg3e512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01010000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg4e512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01110000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg5e512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10010000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg6e512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10110000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg7e512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11010000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg8e512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11110000000000000110000000100111, vm, 0, rs1, vs3); }
void vse512_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00010000000000000110000000100111, vm, 0, rs1, vs3); }
void vsseg1e64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00000000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg2e64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00100000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg3e64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01000000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg4e64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01100000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg5e64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10000000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg6e64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10100000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg7e64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11000000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg8e64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11100000000000000111000000100111, vm, 0, rs1, vs3); }
void vse64_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00000000000000000111000000100111, vm, 0, rs1, vs3); }
void vsseg1e8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00000000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg2e8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00100000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg3e8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01000000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg4e8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b01100000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg5e8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10000000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg6e8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b10100000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg7e8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11000000000000000000000000100111, vm, 0, rs1, vs3); }
void vsseg8e8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b11100000000000000000000000100111, vm, 0, rs1, vs3); }
void vse8_v(VReg vs3, Reg rs1, VM vm=VM::unmasked) { opVectorStore(0b00000000000000000000000000100111, vm, 0, rs1, vs3); }
void vsext_vf2(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01001000000000111010000001010111, vm, vs2, 0, vd); }
void vsext_vf4(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01001000000000101010000001010111, vm, vs2, 0, vd); }
void vsext_vf8(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01001000000000011010000001010111, vm, vs2, 0, vd); }
...
void vsm_v(VReg vs3, Reg rs1) { opVectorStore(0b00000010101100000000000000100111, 0, 0, rs1, vs3); }
...
void vzext_vf2(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01001000000000110010000001010111, vm, vs2, 0, vd); }
void vzext_vf4(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01001000000000100010000001010111, vm, vs2, 0, vd); }
void vzext_vf8(VReg vd, VReg vs2, VM vm=VM::unmasked) { opMVV(0b01001000000000010010000001010111, vm, vs2, 0, vd); }
